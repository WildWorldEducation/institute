...
router.get('/count', (req, res, next) => {
    if (req.session.userName) {
        ...
        let sqlQuery1 =
            'SELECT COUNT(*) AS countRows FROM skills_awaiting_approval';
        ...
        conn.query(sqlQuery1, (err, results) => {
            try {
                ...
                let sqlQuery2 =
                    'SELECT COUNT(*) AS countRows FROM mc_questions_awaiting_approval';
                conn.query(sqlQuery2, (err, results) => {
                    ...
                    let sqlQuery3 =
                        'SELECT COUNT(*) AS countRows FROM essay_questions_awaiting_approval';
