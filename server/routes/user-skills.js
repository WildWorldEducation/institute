...
router.get('/:id', (req, res, next) => {
    if (req.session.userName) {
        ...
        let sqlQuery = `
    SELECT skill_tree.skills.id, name AS skill_name, parent, is_accessible, is_mastered, grade, description, first_ancestor, type, level
    ...
    UNION
    SELECT skill_tree.skills.id, name, parent, "", "", "", description, first_ancestor, type, level
    FROM skill_tree.skills
...
router.get('/no-sub-skills/:id', (req, res, next) => {
    if (req.session.userName) {
        ...
        let sqlQuery = `
    SELECT skill_tree.skills.id, name AS skill_name, parent, is_accessible, is_mastered, grade, description, first_ancestor, type
    FROM skill_tree.skills
    LEFT OUTER JOIN skill_tree.user_skills
    ON skill_tree.skills.id = skill_tree.user_skills.skill_id
    ...
    UNION
    SELECT skill_tree.skills.id, name, parent, "", "", "", description, first_ancestor, type
    FROM skill_tree.skills
    WHERE skill_tree.skills.id NOT IN 
