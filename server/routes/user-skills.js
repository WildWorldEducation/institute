...
router.get('/:id', (req, res, next) => {
    if (req.session.userName) {
        ...
        let sqlQuery = `
    SELECT skill_tree.skills.id, name AS skill_name, parent, mastered_color, unlocked_color, is_accessible, is_mastered, grade, description, first_ancestor, is_sub_skill
    ...
    UNION
    SELECT skill_tree.skills.id, name, parent, mastered_color, unlocked_color, "", "", "", description, first_ancestor, is_sub_skill
    FROM skill_tree.skills
