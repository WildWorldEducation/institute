    ...
    methods: {
        getReferenceSkill() {
            ...
            if (this.inputText.length < 2) {
                ...
                this.suggestSkills = this.skillsStore.skillsList.filter(
                    (skill) => {
...
<template>
    ...
    <div id="main-container" class="container">
        ...
        <div
            id="edit-skill-mastery"
            class="container-fluid mt-5 p-3 p-xl-5 pt-5"
        >
            <div class="row">
                <div
                    class="col-12 col-md-4 col-xl-2 d-flex align-content-center"
                >
    ...
    <div v-if="showModal">
        <div id="myModal" class="modal">
            ...
            <div class="modal-content">
                <p>Yours Change Has Been Applied</p>
