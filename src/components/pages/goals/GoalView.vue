...
<template>
    <div class="container p-3 bg-light rounded">
        ...
        <div class="mb-2 d-flex align-items-center gap-1" v-for="(goalStep, index) in goalSteps">
            <p id="goal-index">{{ index + 1 }})</p>
            <svg
        ...
        <button class="btn red-btn mt-3" @click="deleteGoal()">Delete</button>
    </div>
</template>
