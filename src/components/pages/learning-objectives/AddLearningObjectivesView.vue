...
export default {
        ...
        async addObjective() {
            ...
            try {
                const response = await fetch(
                    `/skill-learning-objectives/${this.skillId}/add`,
                    {
                        method: 'POST',
                        headers: {
                ...
                if (response.ok && data.success) {
                    ...
                    this.errors = [
                        data.message || 'Failed to add learning objective'
                    ];
                }
            } catch (error) {
                console.error('Error adding learning objective:', error);
                this.errors = [
                    'An error occurred while adding the learning objective. Please try again.'
                ];
            } finally {
    ...
    computed: {
        canSubmit() {
            return this.objective.trim().length > 0 && !this.isSubmitting;
        }
    }
};
</script>
...
<template>
    ...
    <div class="container bg-light rounded p-3">
        <!-- Page Heading  -->
        <h1 class="heading">{{ skill.name }} - Add Learning Objective</h1>
        ...
        <div v-else class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12 col-md-8 col-lg-6">
                    ...
                    <!-- Form Card -->
                    <div class="add-form-card bg-white p-4 rounded shadow-sm">
