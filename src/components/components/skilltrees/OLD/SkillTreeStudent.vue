    ...
    async mounted() {
        ...
        font.load().then(
            () => {
                ...
                var skillTreeDivWidth =
                    skillTreeDivStyle.getPropertyValue('width');
                var skillTreeDivHeight =
                    skillTreeDivStyle.getPropertyValue('height');
                ...
                for (let i = 0; i < firstLevelSkillsNum; i++) {
                    ...
                    connectingLineGraphic.position.x =
                        firstLevelSkillContainer.x;
                    connectingLineGraphic.position.y =
                        firstLevelSkillContainer.y;
                    ...
                    firstLevelSkillContainer.addChild(
                        firstLevelSkillNodeGraphic
                    );
                    ...
                    function renderDescendantNodes(
                        ...
                        totalAncestorXPos =
                            totalAncestorXPos + parentContainer.x;
                        totalAncestorYPos =
                            totalAncestorYPos + parentContainer.y;
                        ...
                        for (let [index, child] of parentChildren.entries()) {
                            ...
                            if (child.type != 'sub') {
                                ...
                                nodeAngle =
                                    parentAngle + increment * mainSkillsIndex;
                                ...
                                if (depth == 1)
                                    nodeAngle =
                                        nodeAngle - 67.5 + 67.5 / numChildren;
                                else
                                    nodeAngle =
                                        nodeAngle - 45 + 45 / numChildren;

                                let rads = (nodeAngle * Math.PI) / 180;
                                let x =
                                    nodeContainer.x +
                                    nodeDistance * Math.cos(rads);
                                let y =
                                    nodeContainer.y +
                                    nodeDistance * Math.sin(rads);
                            ...
                            // For subskills, they just go around the super skill (360 degrees).
                                ...
                                let x =
                                    nodeContainer.x +
                                    subNodeDistance * Math.cos(rads);
                                let y =
                                    nodeContainer.y +
                                    subNodeDistance * Math.sin(rads);
                            ...
                            if (parentChildren[index].is_mastered == 1) {
                                ...
                                parentChildren[index].is_accessible == 1
                            ) {
                                nodeGraphic.lineStyle(
                                    1,
                                    '0x' + userSkill.mastered_color,
                                    1
                                );
                            ...
                            // Split name into an array.
                            const nodeNameArray =
                                parentChildren[index].skill_name.split(' ');
