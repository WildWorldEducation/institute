...
export default {
    ...
    methods: {
        ...
        HandlePasswordUpdate() {
            ...
            var url = '/users/profile/' + this.userId + '/edit-password';
            if(this.userDetailsStore.role == 'instructor') url = '/users/' + this.userId + '/edit-student-password';
            if(this.userDetailsStore.role == 'admin') url = '/users/' + this.userId + '/edit-user-password';
        ...
        Submit() {
            ...
            if(this.userDetailsStore.role == 'instructor') url = '/users/profile/' + this.userId + '/edit-student';
...
<template>
    <div class="container mt-3 pb-5">
        <h1 class="h1-stroke">Edit {{ userDetailsStore.role == 'instructor' ? 'Student' : 'User' }}</h1>
        ...
        <div class="container-fluid main-content-container p-4 mt-5">
            <div class="row">
                ...
                <div class="col-lg-4 mt-3">
                    ...
                    <div class="mb-3" v-if="userDetailsStore.role == 'admin'">
                    ...
                    <div v-if="user.role == 'student' && userDetailsStore.role != 'instructor'" class="mb-3">
