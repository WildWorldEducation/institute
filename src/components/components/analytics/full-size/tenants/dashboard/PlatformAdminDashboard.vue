...
export default {
    name: 'Platform-Admin-Class-Dashboard',
    setup() {
    ...
    async created() {
        ...
        if (this.teachers.length < 1) {
            await this.getTeachers(this.tenantId);
        }
    ...
    methods: {
        ...
        async getSchoolProgressData() {
            await this.analyticsStore.getSchoolProgress(this.tenantId);
        ...
        async getSchoolTimeData() {
            await this.analyticsStore.getSchoolTime(this.tenantId);
        ...
        async getSchoolCostData() {
            await this.analyticsStore.getSchoolCost(this.tenantId, 'weekly');
