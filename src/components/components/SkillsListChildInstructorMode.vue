...
<template>
    <button :style="indent" :class="{
    ...
    }" class="skill-button secondary-text d-flex justify-content-between" @click.stop="mainButtonPress()"
        :id="`skill${this.id}`">
        <!-- Emoticons -->
        <div v-if="type != 'domain'">
            ...
            <!-- Grade School level -->
            <img v-if="level == 'grade_school' && isMastered == 1"
                src="/images/skill-emoticons/grade-school-mastered.png" />
            <img v-else-if="level == 'grade_school'" src="/images/skill-emoticons/grade-school-unlocked.png" />
            <!-- Middle School level -->
            <img v-else-if="level == 'middle_school' && isMastered == 1"
                src="/images/skill-emoticons/middle-school-mastered.png" />
            <img v-else-if="level == 'middle_school'" src="/images/skill-emoticons/middle-school-unlocked.png" />
            <!-- High School level -->
            <img v-else-if="level == 'high_school' && isMastered == 1"
                src="/images/skill-emoticons/high-school-mastered.png" />
            <img v-else-if="level == 'high_school'" src="/images/skill-emoticons/high-school-unlocked.png" />
            <!-- College level -->
            <img v-else-if="level == 'college' && isMastered == 1" src="/images/skill-emoticons/college-mastered.png" />
            <img v-else-if="level == 'college'" src="/images/skill-emoticons/college-unlocked.png" />
            <!-- PHD level -->
            <img v-else-if="level == 'phd' && isMastered == 1" src="/images/skill-emoticons/phd-mastered.png" />
            <img v-else-if="level == 'phd'" src="/images/skill-emoticons/phd-unlocked.png" />
            <!-- If skill is locked -->
            <img v-else src="/images/skill-emoticons/middle-school-unlocked.png" />
        </div>
        ...
        <div>
            ...
            <div v-if="type == 'super'" class="d-none d-sm-block text-start pt-1 mastered-skills-count">
        ...
        <div id="buttons" class="d-flex">
            <button v-if="type != 'domain'" class="btn" title="create a goal" @click.stop="
                isMastered == 1 || isUnlocked == 1 || isGoal == 1 || isPseudoGoal
            ...
            <button v-if="type == 'super'" type="button" @click.stop="toggleSubSkills" class="btn me-2 ci-btn">
                <!-- Plus sign -->
                <svg v-if="!showSubskills" width="18" height="18" class="primary-icon"
                ...
                <!-- Minus sign -->
                <svg v-else width="18" height="18" class="primary-icon" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512">
                    <!-- !Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc. -->
                    <path
            ...
            <button class="btn me-2 ci-btn" v-if="type == 'domain'" @click.stop="toggleExpandAll">
                <svg v-if="showChildren" height="18" width="18" class="primary-icon" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512">
                    <!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc. -->
                    <path
                ...
                <svg v-else height="18" width="18" class="primary-icon" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512">
                    <!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.
                    -->
                    <path
            ...
            <button v-if="childrenNotSubskills.length != 0" @click.stop="toggleChildren" class="btn me-2 ci-btn">
                <!-- Collapse icon -->
                <svg v-if="!showChildren" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" width="18"
                    height="18" class="primary-icon">
                    <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc. -->
                    <path
                        d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z" />
                </svg>
                <svg v-else xmlns="http://www.w3.org/20da00/svg" viewBox="0 0 512 512" width="18" height="18"
                    class="primary-icon">
                    <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc. -->
                    <path
    ...
    <!-- Sub skills -->
    <SkillsListChildInstructorMode v-if="showSubskills" v-for="subSkill in subSkills" :id="subSkill.id"
        :children="subSkill.children" :isUnlocked="subSkill.is_accessible" :isMastered="subSkill.is_mastered"
        :isGoal="subSkill.is_goal" :type="subSkill.type" :level="subSkill.level" :name="subSkill.skill_name"
        :isFiltered="subSkill.isFiltered" :role="role" :depth="depth + 1" :path="path" :studentId="studentId"
        :parent="subSkill.parent" :isStudentSkillsLocked="isStudentSkillsLocked">
    </SkillsListChildInstructorMode>

    <!-- Recursive nesting of component -->
    <SkillsListChildInstructorMode v-if="showChildren" v-for="child in childrenNotSubskills" :id="child.id"
        :children="child.children" :isUnlocked="child.is_accessible" :isMastered="child.is_mastered"
        :isGoal="child.is_goal" :type="child.type" :level="child.level" :name="child.skill_name"
        :isFiltered="child.isFiltered" :role="role" :depth="depth + 1" :path="path" :studentId="studentId"
        :parent="child.parent" :isStudentSkillsLocked="isStudentSkillsLocked">
    </SkillsListChildInstructorMode>
</template>
