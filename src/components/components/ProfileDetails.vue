...
<template>
    <div class="container pb-4">
        <h1 id="page-tile" class="my-3">Profile</h1>
        <div class="row">
        ...
        <p v-else-if="userDetailsStore.role == 'instructor'">
          <strong>role:</strong>
        ...
        <div class="row">
            <div class="col col-5 d-flex flex-column flex-md-row gap-3">
                <router-link
                ...
                <div class="">
                    ...
                    <a v-else href="/login" class="btn purple-btn" role="button"
                        >Log in</a
                    >
                </div>
            </div>
