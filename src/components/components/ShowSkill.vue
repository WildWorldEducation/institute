                    ...
                    <div class="d-flex" :class="{
                        ...
                        <span class="d-flex">
                            ...
                            <button v-if="
                                ...
                                isGoal == false &&
                                userDetailsStore.role == 'student'
                            " class="btn primary-btn" @click="openModal(skill)">
                        ...
                        <span class="d-flex">
                            ...
                            <!-- Flag button -->
                            <button v-if="sessionDetailsStore.isLoggedIn" @click="showFlaggingModal = true" class="btn"
                                b-tooltip.hover title="Report this skill to the admin if it has errors">
