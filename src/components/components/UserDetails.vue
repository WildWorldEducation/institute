...
<template>
    <div id="user-information" class="container mt-3">
        <div class="row">
            <div class="col-6 d-flex flex-column">
                <img :src="this.$parent.user.avatar">
                <div class="d-flex justify-content-center">
                    <router-link :to="'/users/edit/' + this.$parent.user.id" class="btn purple-btn">
                        Edit&nbsp;
                        <!-- Pencil icon -->
                    ...
                    <button class="btn red-btn" @click="usersStore.deleteUser(userId)">
                        Delete&nbsp;
                        <!-- X icon -->
