...
<template>
  ...
  <div class="row forum-container mt-3" v-for="post in orderedAndNamedPosts">
    <div class="row">
      <div class="d-flex flex-row justify-content-end">
        <button
          @click="voteUp(post.index, post.id, post.userUpVote)"
          class="btn"
          type="button"
        >
          <svg
        ...
        <button
          @click="voteDown(post.index, post.id, post.userDownVote)"
          class="btn"
          type="button"
        >
          <svg
        ...
        <button
          v-if="post.user_id == user.userId || user.role == 'admin'"
          type="button"
          class="btn"
  ...
  <!-- This is a sample forum container with mock data for dev -->
  <div class="row forum-container mt-3">
    <div class="row">
      <div class="d-flex flex-row justify-content-end">
        ...
        <router-link class="btn" role="button">
          <!-- Pencil icon -->
          <svg
            width="19"
            height="20"
