...
<template>
    <div class="login-page">
        <div class="form-signin">
            <div class="text-center"><img class="mb-4" src="/images/logo-red.png" alt="" width="72" height="72"></div>
            <h1 class="h3 mb-3 font-weight-normal">Student log in</h1>

            <div class="mt-3">
                <label class="mb-4 welcome-message">Welcome back! Please enter your details.</label>
                ...
                <button class="btn btn-dark mb-2" @click="Submit()">Sign in</button>
                <div id="g_id_onload"
                    data-client_id="13191319610-qectaoi146ce1pm4v95jtgctsbtmqb3t.apps.googleusercontent.com"
                    data-context="signin" data-ux_mode="popup" data-login_uri="/google-login-attempt"
                    data-auto_prompt="false">
                </div>
                <div class="g_id_signin" data-type="standard" data-shape="rectangular" data-theme="outline"
                    data-text="signin_with" data-size="large" data-logo_alignment="left" data-width="330">
                </div>
                <div class="mt-4 signup  text-center">Don’t have an account? <a href="#" class="links">Sign up</a></div>
            </div>
        </div>
    </div>
</template>
