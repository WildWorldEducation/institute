...
export default {
    ...
    async created() {
        ...
        this.countImageRequireNumberChange();
    ...
    methods: {
        ...
        updateTempData(type, value) {
            switch (type) {
                case 'image_question_name':
                    this.tempQuestionEdit.name = value;
                    break;
                case 'image_question_question':
                    this.tempQuestionEdit.question = value;
                default:
                    break;
            }
        },
        countImageRequireNumberChange() {
...
<template>
    <div class="container mb-2 bg-light rounded p-3">
        ...
        <ComparisonContainer
            ...
            :newData="imageQuestionEdit.name"
            :isEditMode="isEditMode"
            type="image_question_name"
        ...
        <ComparisonContainer
            ...
            :originalData="imageQuestion.question"
            :newData="imageQuestionEdit.question"
            :isEditMode="isEditMode"
            type="image_question_question"
            :updateTempData="updateTempData"
            :singleComponent="true"
        />
