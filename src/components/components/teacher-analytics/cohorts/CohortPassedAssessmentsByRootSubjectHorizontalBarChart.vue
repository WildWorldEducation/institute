...
export default {
    name: 'CohortPassedAssessmentsByRootSubjectHorizontalBarChart',
    props: ['data', 'colour'],
    data() {
        return {};
    },
    mounted() {
        const container = d3.select(
            '#cohort-passed-assessments-by-root-subject-chart-container'
        );
...
<template>
    <div id="cohort-passed-assessments-by-root-subject-chart-container"></div>
</template>
