...
export default {
    ...
    data() {
        return {
            ...
            allConnectingLinesArray: [],
            allNodeContainersArray: [],
            crossingSkills: []
        }
    },
    components: {
            ...
            for (let i = 0; i < firstLevelSkillsNum; i++) {
                ...
                function renderDescendantNodes(parentChildren, parentContainer, parentAngle, totalAncestorXPos, totalAncestorYPos, depth, context) {
                    ...
                    for (let [index, child] of parentChildren.entries()) {
                        ...
                        context.allConnectingLinesArray.push(connectingLine)
                        context.allNodeContainersArray.push(nodeContainer)
                ...
                // var j = 0
                // for (let i = 0; i < this.allConnectingLinesArray.length; i++) {
                //     for (let k = 0; k < this.allConnectingLinesArray.length; k++) {
                //         console.log(intersects(
                //             this.allConnectingLinesArray[i].position.x,
                //             this.allConnectingLinesArray[i].position.y,
                //             this.allNodeContainersArray[i].x,
                //             this.allNodeContainersArray[i].y,
                //             this.allConnectingLinesArray[k].position.x,
                //             this.allConnectingLinesArray[k].position.y,
                //             this.allNodeContainersArray[k].x,
                //             this.allNodeContainersArray[k].y
                //         ))
                ...
                //         )) {
                //             j++
                //             this.crossingSkills.push(this.allNodeContainersArray[i])
                //         }
                //     }
                // }
                // console.log(j)
                // console.log(this.crossingSkills)
