...
<template>
    <button :style="indent" :class="{
        ...
        <div v-if="depth > 1">
            ...
            <!-- 1 Spoken Language -->
            <img v-if="firstAncestor == 1 && isMastered == 1" src="/images/skill-emoticons/spoken-language-mastered.png">
            <img v-else-if="firstAncestor == 1 && isUnlocked == 1"
                src="/images/skill-emoticons/spoken-language-unlocked.png">
            <img v-else-if="firstAncestor == 1" src="/images/skill-emoticons/spoken-language-unlocked.png"
                class="locked-skill-styling">
            <!-- 2 Written Language -->
            <img v-if="firstAncestor == 2 && isMastered == 1" src="/images/skill-emoticons/written-language-mastered.png">
            <img v-else-if="firstAncestor == 2 && isUnlocked == 1"
                src="/images/skill-emoticons/written-language-unlocked.png">
            <img v-else-if="firstAncestor == 2" src="/images/skill-emoticons/written-language-unlocked.png"
                class="locked-skill-styling">
            <!-- 3 Mathematics -->
            <img v-if="firstAncestor == 3 && isMastered == 1" src="/images/skill-emoticons/mathematics-mastered.png">
            <img v-else-if="firstAncestor == 3 && isUnlocked == 1" src="/images/skill-emoticons/mathematics-unlocked.png">
            <img v-else-if="firstAncestor == 3" src="/images/skill-emoticons/mathematics-unlocked.png"
                class="locked-skill-styling">
            <!-- 4 Science -->
            <img v-if="firstAncestor == 4 && isMastered == 1" src="/images/skill-emoticons/science-mastered.png">
            <img v-else-if="firstAncestor == 4 && isUnlocked == 1" src="/images/skill-emoticons/science-unlocked.png">
            <img v-else-if="firstAncestor == 4" src="/images/skill-emoticons/science-unlocked.png"
                class="locked-skill-styling">
            <!-- 5 History -->
            <img v-if="firstAncestor == 5 && isMastered == 1" src="/images/skill-emoticons/history-mastered.png">
            <img v-else-if="firstAncestor == 5 && isUnlocked == 1" src="/images/skill-emoticons/history-unlocked.png">
            <img v-else-if="firstAncestor == 5" src="/images/skill-emoticons/history-unlocked.png"
                class="locked-skill-styling">
            <!-- 6 Life -->
            <img v-if="firstAncestor == 6 && isMastered == 1" src="/images/skill-emoticons/life-mastered.png">
            <img v-else-if="firstAncestor == 6 && isUnlocked == 1" src="/images/skill-emoticons/life-unlocked.png">
            <img v-else-if="firstAncestor == 6" src="/images/skill-emoticons/life-unlocked.png"
                class="locked-skill-styling">
        </div>
        <span style="text-align: left">{{ name }}</span>
        <!-- Buttons -->
        <div id="buttons" class="d-flex">
            <router-link v-if="isUnlocked == 1 || role == 'admin'" :to="'/skills/' + id" class="btn me-2 ci-btn"
                role="button">
                <!-- Eye icon -->
            ...
            <button v-if="role == 'admin'" type="button" @click="DeleteSkill(id).stop" class="btn delete-btn me-2 ci-btn">
                <!-- X icon -->
            ...
            <button v-if="isSuperSkill" type="button" @click="toggleSubSkills" class="btn me-2 ci-btn">
                Sub skills
            </button>
        </div>
