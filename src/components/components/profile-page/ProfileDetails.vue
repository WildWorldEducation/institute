            ...
            <div class="col-12 col-md-6">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-md-none">
                        <!-- Log in -->
                        <a
                            v-if="sessionDetailsStore.isLoggedIn == false"
                            href="/login"
                ...
                <div class="row my-3 mx-0">
                    <div
                        class="col-12 col-5 d-none d-md-flex gap-3 flex-row justify-content-center justify-content-md-start ps-md-0"
                    >
                        <router-link
