...
<template>
    <div id="user-information" class="container mt-1 bg-light p-2">
        <div class="row">
            <div class="col">
                <h4 class="secondary-heading">Students of Instructor</h4>
                <ul>
                    <li v-for="student in studentOfInstructor" :key="student.id">
                        {{ student.username }}
                    </li>
                </ul>
            </div>
                        ...
                        <div id="myModal" class="modal">
                            ...
                            <div class="modal-content">
                                ...
                                <div style="display: flex; gap: 10px">
                                    <button type="button" class="btn btn-danger" :disabled="isWaiting"
                                        @click="deleteTeacher">
                                        Yes
                                    </button>
                                    <button type="button" :disabled="isWaiting" class="btn btn-dark"
