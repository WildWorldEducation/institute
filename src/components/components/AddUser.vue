      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="mb-3 row">
            ...
            <div v-if="!image">
              <input id="choose-avatar" type="file" accept="image/*" @change="onFileChange" hidden />
              <label class="btn green-btn" for="choose-avatar">Add&nbsp;&nbsp;
                <!-- Plus sign -->
            ...
            <div v-else>
              <p>
                <img :src="image" height="300" style="background-color: lightgrey" />
              </p>
              <p>
        ...
        <div class="col-lg-4">
          ...
          <div class="mb-3">
            ...
            <div v-if="validate.email && (user.email == '' || user.email == null)" class="form-validate">
          ...
          <div class="mb-3">
            ...
            <div class="d-flex flex-column">
              ...
              <div v-if="showRoleDropDown" class="custom-dropdown-base">
                <div class="custom-dropdown-option" @click="
                  userRole = 'student';
                showRoleDropDown = false;
                ">
                  student
          ...
          <div v-if="user.role == 'student'" class="mb-3">
            ...
            <div class="d-flex flex-column">
              ...
              <div v-if="showDropDown" class="custom-dropdown-base">
                <div v-for="instructor in instructors" class="custom-dropdown-option" @click="
