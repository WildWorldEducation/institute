...
export default {
    ...
    props: [`posts`, 'user', 'skillId', 'showTutorialTip7', 'userRole'],
    data() {
        return {
    ...
    computed: {
        ...
        tutorialTipContent() {
            return this.userRole === 'editor' || this.userRole === 'instructor'
                ? 'You can also share resources that you have personally used to learn about this topic. Your contributions can help others in their learning journey.'
                : 'You can also volunteer to tutor others on this subject and share resources you, personally, have used to learn about this topic';
        }
    },
    methods: {
